  ...
  <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-12">
          <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
              <h5 class="card-title">Recent Sales <span>| Now</span></h5>
    ...
    <div class="col-lg-4">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <h5 class="card-title">Recent Product Type <span>| Now</span></h5>
      ...
      <div class="card">
        ...
        <div class="card-body pb-0">
          <h5 class="card-title">Data Product <span>| Now</span></h5>
            ...
            document.addEventListener("DOMContentLoaded", () => {
              echarts.init(document.querySelector("#trafficChart")).setOption({
                ...
                series: [{
                  ...
                  data: [
                    <?php foreach($grafikData as $key => $dataProduct) : ?>
                    {
                      value: <?php echo $dataProduct->countdata?>,
                      name: "<?php echo $dataProduct->productLine ?>"
                    },
                    <?php endforeach?>
                  ]
                }]
